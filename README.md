# Callbacks Lab
### Changes I made
* Text for the timer is "Time elapsed: x seconds" instead of "Time elapsed: x" for clarity.
* When 'Pause' is clicked, button text is changed to 'Resume'.
* When stopwatch is paused, clicking on either 'Start' or 'Resume' will resume the timer.
